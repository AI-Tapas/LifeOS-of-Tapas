...
import { schemaStats } from "@/lib/assistant/tools";
...
export async function GET(req: Request): Promise<Response> {
  ...
  const build = {
    ...
    tool_parameters: stats.parameters,
    tool_optional: stats.optional,
    tool_unions: stats.unions,
    strict_tools: process.env.LLM_STRICT === "on",
  };
